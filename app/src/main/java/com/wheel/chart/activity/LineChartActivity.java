package com.wheel.chart.activity;
...
import com.wheel.chart.data.CompositeIndexBean;
import com.wheel.chart.data.IncomeBean;
import com.wheel.chart.data.LineChartBean;
import com.wheel.chart.manager.LineChartManager;
import com.wheel.chart.utils.LocalJsonAnalyzeUtil;
...
public class LineChartActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //展示图表
        lineChartManager1.showLineChart(incomeBeanList, "我的收益", getResources().getColor(R.color.colorPrimary));
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.cl_shanghai:
                    ...
                    lineChartManager1.resetLine(1, shanghai, "上证指数", getResources().getColor(R.color.colorPrimary));
                    break;
                case R.id.cl_shenzhen:
                    ...
                    lineChartManager1.resetLine(1, shenzheng, "深证指数", getResources().getColor(R.color.colorPrimary));
                    break;
                case R.id.cl_gem:
                    ...
                    lineChartManager1.resetLine(1, GEM, "创业指数", getResources().getColor(R.color.colorPrimary));
                    break;
            }
        }
    };
